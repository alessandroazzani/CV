...
\newcommand{\email}{\href{mailto:aazzani@ethz.ch}{aazzani@ethz.ch}}
...
\cventry{\itshape Sep 2022 - Sep 2024}{
...
\intrasectionsep
\cventryright{
    \underline{Current GPA:} {$5.91 / 6$}\cvpdf{https://drive.google.com/file/d/1SbKwXSCdkGey8kEVAvKElrJMtL9JM0HO/view?usp=share_link}
}
...
\intrasectionsep
\cventryright{
    \underline{Research Project:}
    \begin{indentitem}
        \item {\scshape Title:} \emph{Mitigating Crosstalk and Generating Photonic Tree Graph States in Superconducting Circuits"}\cvpdf{https://drive.google.com/file/d/13nsFrUXQ6SJIF-AYRefGkCsanhVC4wiN/view?usp=share_link}
        \item {\scshape Principal Investigator:} Prof. Dr. Andreas Wallraff
    \end{indentitem}
}
\intersectionsep
